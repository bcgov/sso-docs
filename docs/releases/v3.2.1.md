...
- Updated to ensure Keycloak login title to be case sensitive, aligned with field "SSO Login Page Name". This change gives clients flexibility, before this change, Keycloak login page title is in upper case only.
