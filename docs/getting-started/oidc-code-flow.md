...
### Ensure your development team understands the fundamentals of OIDC
...
Pathfinder SSO clients use the [Authorization Code Flow](https://auth0.com/docs/authorization/flows/authorization-code-flow). This is the modern, recommended OIDC setup for web and mobile applications.
