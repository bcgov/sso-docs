...
content: <><p>The information about integrating BCSC login with the application can be found in this <a href={"https://stackoverflow.developer.gov.bc.ca/questions/512/515#515"}>discussion</a>.</p></>},
...
content: <><p>Please refer to the following <a href={"https://stackoverflow.developer.gov.bc.ca/questions/1185/1186#1186"}>discussion</a> for the similar question.</p></>},
